...
/**
 * Database (Catalog) where the source is located
 */
export type SchemaSourceDatabase = string;
/**
 * A description for the source
 */
export type SchemaSourceDescription = string;
/**
...
/**
 * Schema where this source is located
 */
export type SchemaSourceSchema = string;
/**
...
export interface SchemaSource {
  ...
  /**
   * Tables to include from this schema
   */
  tables: SchemaSourceTable[];
}
/**
